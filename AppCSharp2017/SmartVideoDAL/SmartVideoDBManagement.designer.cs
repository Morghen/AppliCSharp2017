...
namespace SmartVideoDAL
{
    ...
    partial void OnpositionChanged();
        ...
        public override bool Equals(object obj)
        {
            var statistique = obj as Statistique;
            return statistique != null &&
                   id == statistique.id &&
                   date.Year == statistique.date.Year && date.Month == statistique.date.Month && date.Day == statistique.date.Day &&
                   type == statistique.type;
        }
    }
